    ...
    return (
        <div className="space-y-8 animate-fadeIn">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <StatCard icon="cash-outline" label="Total Earned" value="₹800" color="yellow" />
            </div>
...
const MyCourses: React.FC = () => (
    <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden">
                <img src="https://picsum.photos/seed/design2/600/300" alt="Graphic Design" className="w-full h-40 object-cover" />
                <div className="p-6">
                    <h3 className="text-xl font-semibold">Graphic Design (Hindi)</h3>
                    <p className="text-sm text-gray-500 mt-1">Mentor: Suraj P. (SSG, BHU Varanasi)</p>
                    <div className="w-full bg-gray-200 rounded-full h-2.5 mt-4">
...
const FreelanceHub: React.FC = () => {
    ...
    return (
        <div>
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">Available Group Projects</h2>
            <p className="text-gray-600 mb-6">These projects are completed by teams of learners under the guidance of a certified mentor. Express your interest to join a team!</p>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
    ...
    <div>
        ...
        <div className="bg-white p-6 rounded-lg shadow-lg">
            ...
            <div className="flex flex-wrap gap-2 mt-2">
                <span className="px-3 py-1 bg-green-100 text-green-800 rounded-full text-sm font-medium">Graphic Design</span>
            ...
            <div className="mt-4 space-y-4">
                <div className="border border-gray-200 rounded-lg p-4 flex items-center justify-between">
                    <div>
                        <h4 className="font-semibold text-indigo-600">"Sharma Sweets" - Logo Design</h4>
                        <p className="text-sm text-gray-500">Graphic Design | Group Project</p>
                    </div>
